...
%\usepackage{palatino}
\usepackage[
    pdftitle={GNOME Desktop Programming: Writing software for GNOME 3},
    pdfauthor={Christian Hergert},
    pdfsubject={GNOME Desktop Programming.},
...
\renewcommand{\dblfloatpagefraction}{0.6}	% require fuller float pages
